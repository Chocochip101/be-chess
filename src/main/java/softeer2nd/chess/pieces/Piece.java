...
public class Piece {
    ...
    public boolean equals(Object o) {
        ...
        Piece piece = (Piece) o;
        return representation == piece.representation && Objects.equals(color, piece.color) && Objects.equals(point, piece.point);
    }

    @Override
    public int hashCode() {
        return Objects.hash(color, representation, point);
    }
}